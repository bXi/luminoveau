...
// ─────────────────────────────────────────────────────────────────────────────
// SdlGpuBackend — IGpu implementation over SDL3 GPU API.
// Owns the SDL_GPUDevice and all SDL_GPU resources.
// ─────────────────────────────────────────────────────────────────────────────

struct SDL_GPUDevice;
struct SDL_Window;

class SdlGpuBackend final : public IGpu, public IBackendAccess {
public:
    explicit SdlGpuBackend(SDL_GPUDevice* device);
    ...
    void* getRawDevice() const override;
