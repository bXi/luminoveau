...
GpuTextureFormat fromSDL(SDL_GPUTextureFormat fmt) {
    ...
    case SDL_GPU_TEXTUREFORMAT_R8_UNORM:
        return GpuTextureFormat::R8_Unorm;
    case SDL_GPU_TEXTUREFORMAT_R8G8_UNORM:
        return GpuTextureFormat::R8G8_Unorm;
    ...
    case SDL_GPU_TEXTUREFORMAT_R16_FLOAT:
        return GpuTextureFormat::R16_Float;
    case SDL_GPU_TEXTUREFORMAT_R16G16_FLOAT:
        return GpuTextureFormat::R16G16_Float;
    case SDL_GPU_TEXTUREFORMAT_R16G16B16A16_FLOAT:
        return GpuTextureFormat::R16G16B16A16_Float;
    case SDL_GPU_TEXTUREFORMAT_R32_FLOAT:
        return GpuTextureFormat::R32_Float;
    case SDL_GPU_TEXTUREFORMAT_R32G32_FLOAT:
        return GpuTextureFormat::R32G32_Float;
    case SDL_GPU_TEXTUREFORMAT_R32G32B32A32_FLOAT:
        return GpuTextureFormat::R32G32B32A32_Float;
    case SDL_GPU_TEXTUREFORMAT_R10G10B10A2_UNORM:
        return GpuTextureFormat::R10G10B10A2_Unorm;
    case SDL_GPU_TEXTUREFORMAT_B5G6R5_UNORM:
        return GpuTextureFormat::B5G6R5_Unorm;
    case SDL_GPU_TEXTUREFORMAT_D16_UNORM:
        return GpuTextureFormat::D16_Unorm;
    case SDL_GPU_TEXTUREFORMAT_D24_UNORM:
        return GpuTextureFormat::D24_Unorm;
    case SDL_GPU_TEXTUREFORMAT_D32_FLOAT:
        return GpuTextureFormat::D32_Float;
    case SDL_GPU_TEXTUREFORMAT_D24_UNORM_S8_UINT:
        return GpuTextureFormat::D24_Unorm_S8_Uint;
    case SDL_GPU_TEXTUREFORMAT_D32_FLOAT_S8_UINT:
        return GpuTextureFormat::D32_Float_S8_Uint;
    case SDL_GPU_TEXTUREFORMAT_BC7_RGBA_UNORM:
        return GpuTextureFormat::BC7_Unorm;
    case SDL_GPU_TEXTUREFORMAT_ASTC_4x4_UNORM:
        return GpuTextureFormat::ASTC_4x4_Unorm;
    default:
...
SDL_GPUTransferBufferUsage toSDL(GpuTransferUsage usage) {
    switch (usage) {
    case GpuTransferUsage::Upload:
        return SDL_GPU_TRANSFERBUFFERUSAGE_UPLOAD;
    case GpuTransferUsage::Download:
...
SDL_GPUVertexElementFormat toSDL(GpuVertexElementFormat fmt) {
    ...
    case GpuVertexElementFormat::Byte2:
        return SDL_GPU_VERTEXELEMENTFORMAT_BYTE2;
    case GpuVertexElementFormat::Byte4:
        return SDL_GPU_VERTEXELEMENTFORMAT_BYTE4;
    case GpuVertexElementFormat::UByte2:
        return SDL_GPU_VERTEXELEMENTFORMAT_UBYTE2;
    case GpuVertexElementFormat::UByte4:
...
SDL_GPUTextureType toSDL(GpuTextureType t) {
    switch (t) {
    case GpuTextureType::Tex2DArray:
        return SDL_GPU_TEXTURETYPE_2D_ARRAY;
    case GpuTextureType::TexCube:
