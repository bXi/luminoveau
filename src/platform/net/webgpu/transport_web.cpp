...
public:
    ...
    void          DisconnectPeer(Net::Peer) override { }
    ...
    uint32_t      MaxMessageSize() const override { return 0; }
    Net::NetError LastError() const override { return Net::NetError::NoTransport; }
...
/// @cond INTERNAL
ITransport *createWebTransport() { return new WebTransport(); }
/// @endcond
...
Net::Udp::Socket  Net::Udp::_openBroadcast(uint16_t) { return nullptr; }
void              Net::Udp::_close(Net::Udp::Socket) { }
bool              Net::Udp::_send(Net::Udp::Socket, const Net::Udp::Address &, const void *, int) { return false; }
bool              Net::Udp::_broadcast(Net::Udp::Socket, uint16_t, const void *, int) { return false; }
