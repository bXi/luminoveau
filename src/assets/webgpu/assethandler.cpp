...
ShaderAsset AssetHandler::_loadShaderFromDisk(const std::string &fileName) {
    ...
    glslRes.maxLights                                   = 32;
    glslRes.maxClipPlanes                               = 6;
    glslRes.maxTextureUnits                             = 32;
    glslRes.maxTextureCoords                            = 32;
    glslRes.maxVertexAttribs                            = 64;
    glslRes.maxVertexUniformComponents                  = 4096;
    glslRes.maxVaryingFloats                            = 64;
    glslRes.maxVertexTextureImageUnits                  = 32;
    glslRes.maxCombinedTextureImageUnits                = 80;
    glslRes.maxTextureImageUnits                        = 32;
    glslRes.maxFragmentUniformComponents                = 4096;
    glslRes.maxDrawBuffers                              = 32;
    glslRes.maxVertexUniformVectors                     = 128;
    glslRes.maxVaryingVectors                           = 8;
    glslRes.maxFragmentUniformVectors                   = 16;
    glslRes.maxVertexOutputVectors                      = 16;
    glslRes.maxFragmentInputVectors                     = 15;
    glslRes.minProgramTexelOffset                       = -8;
    glslRes.maxProgramTexelOffset                       = 7;
    glslRes.maxClipDistances                            = 8;
    glslRes.maxComputeWorkGroupCountX                   = 65535;
    glslRes.maxComputeWorkGroupCountY                   = 65535;
    glslRes.maxComputeWorkGroupCountZ                   = 65535;
    glslRes.maxComputeWorkGroupSizeX                    = 1024;
    glslRes.maxComputeWorkGroupSizeY                    = 1024;
    glslRes.maxComputeWorkGroupSizeZ                    = 64;
    glslRes.maxComputeUniformComponents                 = 1024;
    glslRes.maxComputeTextureImageUnits                 = 16;
    glslRes.maxComputeImageUniforms                     = 8;
    glslRes.maxComputeAtomicCounters                    = 8;
    glslRes.maxComputeAtomicCounterBuffers              = 1;
    glslRes.maxVaryingComponents                        = 60;
    glslRes.maxVertexOutputComponents                   = 64;
    glslRes.maxGeometryInputComponents                  = 64;
    glslRes.maxGeometryOutputComponents                 = 128;
    glslRes.maxFragmentInputComponents                  = 128;
    glslRes.maxImageUnits                               = 8;
    glslRes.maxCombinedImageUnitsAndFragmentOutputs     = 8;
    glslRes.maxCombinedShaderOutputResources            = 8;
    glslRes.maxImageSamples                             = 0;
    glslRes.maxVertexImageUniforms                      = 0;
    glslRes.maxTessControlImageUniforms                 = 0;
    glslRes.maxTessEvaluationImageUniforms              = 0;
    glslRes.maxGeometryImageUniforms                    = 0;
    glslRes.maxFragmentImageUniforms                    = 8;
    glslRes.maxCombinedImageUniforms                    = 8;
    glslRes.maxGeometryTextureImageUnits                = 16;
    glslRes.maxGeometryOutputVertices                   = 256;
    glslRes.maxGeometryTotalOutputComponents            = 1024;
    glslRes.maxGeometryUniformComponents                = 1024;
    glslRes.maxGeometryVaryingComponents                = 64;
    glslRes.maxTessControlInputComponents               = 128;
    glslRes.maxTessControlOutputComponents              = 128;
    glslRes.maxTessControlTextureImageUnits             = 16;
    glslRes.maxTessControlUniformComponents             = 1024;
    glslRes.maxTessControlTotalOutputComponents         = 4096;
    glslRes.maxTessEvaluationInputComponents            = 128;
    glslRes.maxTessEvaluationOutputComponents           = 128;
    glslRes.maxTessEvaluationTextureImageUnits          = 16;
    glslRes.maxTessEvaluationUniformComponents          = 1024;
    glslRes.maxTessPatchComponents                      = 120;
    glslRes.maxPatchVertices                            = 32;
    glslRes.maxTessGenLevel                             = 64;
    glslRes.maxViewports                                = 16;
    glslRes.maxVertexAtomicCounters                     = 0;
    glslRes.maxTessControlAtomicCounters                = 0;
    glslRes.maxTessEvaluationAtomicCounters             = 0;
    glslRes.maxGeometryAtomicCounters                   = 0;
    glslRes.maxFragmentAtomicCounters                   = 8;
    glslRes.maxCombinedAtomicCounters                   = 8;
    glslRes.maxAtomicCounterBindings                    = 1;
    glslRes.maxVertexAtomicCounterBuffers               = 0;
    glslRes.maxTessControlAtomicCounterBuffers          = 0;
    glslRes.maxTessEvaluationAtomicCounterBuffers       = 0;
    glslRes.maxGeometryAtomicCounterBuffers             = 0;
    glslRes.maxFragmentAtomicCounterBuffers             = 1;
    glslRes.maxCombinedAtomicCounterBuffers             = 1;
    glslRes.maxAtomicCounterBufferSize                  = 16384;
    glslRes.maxTransformFeedbackBuffers                 = 4;
    glslRes.maxTransformFeedbackInterleavedComponents   = 64;
    glslRes.maxCullDistances                            = 8;
    glslRes.maxCombinedClipAndCullDistances             = 8;
    glslRes.maxSamples                                  = 4;
    glslRes.limits.nonInductiveForLoops                 = 1;
    glslRes.limits.whileLoops                           = 1;
    glslRes.limits.doWhileLoops                         = 1;
    glslRes.limits.generalUniformIndexing               = 1;
    glslRes.limits.generalAttributeMatrixVectorIndexing = 1;
    glslRes.limits.generalVaryingIndexing               = 1;
    glslRes.limits.generalSamplerIndexing               = 1;
