...
struct ModelAsset {
    ...
    void SetCubeFaceUVs(CubeFace face, const FaceUV &uvs) {
        ...
        vertices[base + 0].u = uvs.uMin;
        vertices[base + 0].v = uvs.vMax;
        vertices[base + 1].u = uvs.uMax;
        vertices[base + 1].v = uvs.vMax;
        vertices[base + 2].u = uvs.uMax;
        vertices[base + 2].v = uvs.vMin;
        vertices[base + 3].u = uvs.uMin;
        vertices[base + 3].v = uvs.vMin;
    }
};
