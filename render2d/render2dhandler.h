...
public:
    ...
    [[maybe_unused]] static void DrawRectangleFilled(vf2d pos, vf2d size, Color color) { get()._drawRectangle(pos, size, color); };
    [[maybe_unused]] static void DrawRectangleRoundedFilled(vf2d pos, vf2d size, float radius, Color color) { get()._drawRectangleRounded(pos, size, radius, color); };
    [[maybe_unused]] static void DrawCircleFilled(vf2d pos, float radius, Color color) { get()._drawCircle(pos, radius, color); };
    [[maybe_unused]] static void DrawCircleSectorFilled(vf2d center, float radius, float startAngle, float endAngle, int segments, Color color) { get()._drawCircleSector(center, radius, startAngle, endAngle, segments, color); };
