...
//    {
//        if (get()._shaders.contains(ID)) {
//            return get()._shaders.at(ID);
//        }
//        return nullptr;
//
//    }
...
//    {
//        auto* temp = new Shader(vs, fs);
//        get()._shaders[temp->ID] = temp;
//        return temp;
//    }
//
//private:
...
//    static Shaders& get() { static Shaders instance; return instance; }
//private:
//    Shaders() = default;
//};