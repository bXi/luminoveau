...
public:
	...
	std::function<float(float time, float startValue, float change, float duration)> callback = [](float _time, float _startValue, float _change, float _duration)
	{
...
public:
	...
	static Lerp& get() { static Lerp instance; return instance; }
