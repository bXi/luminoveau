...
Output main(uint id : SV_VertexID)
{
    ...
    if (sprite.Rotation != 0.0) {
        ...
        c = cos(sprite.Rotation);
        s = sin(sprite.Rotation);

        coord-= sprite.Pivot; // Adjust by sprite.Pivot point
    }
    ...
    if (sprite.Rotation != 0.0) {
        ...
        coord += (sprite.Pivot * sprite.Scale); // Reapply pivot offset after rotation
    }
